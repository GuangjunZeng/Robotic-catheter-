% 定义四个角点的坐标
start_point = [1350-1000, 900-800]; % 右上角
bottom_right = [1350-1000, 1450-900]; % 右下角
bottom_left = [650-1000, 1450-900]; % 左下角
top_left = [650-1000, 900-800]; % 左上角
...
for i = 1:4
    ...
    % 计算步长，假设每次移动10个单位
    steps = max(abs(x_diff), abs(y_diff)) / 5;
...
save('F:\capstone2025\small_myRIO_Helmholtz DGMM controller\trajectory_data.mat', 'trajectory');
