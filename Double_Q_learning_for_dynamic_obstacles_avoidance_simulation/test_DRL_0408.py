...
socket.bind("tcp://0.0.0.0:0226") # 服务器端（Server）
...
while True:
    ...
    try:
        relative_real_x_color, relative_real_y_color,t = message['relative_real_x_color'], message['relative_real_y_color'], message['t']
