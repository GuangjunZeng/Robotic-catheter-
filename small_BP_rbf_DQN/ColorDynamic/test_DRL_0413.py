...
parser.add_argument('--basic_ctrl_interval', type=float, default=0.2, help='control interval (s), 0.1 means 10 Hz control frequency')
    ...
    try:
        ...
        if envs.step_counter_vec < time_begin_action: #当没到时间时，next_relative_desired_point根本不会有任何作用影响
            ...
            if envs.step_counter_vec == time_begin_action:
                ...
                new_orientation = torch.atan2(new_delta[:, 1], new_delta[:, 0])
